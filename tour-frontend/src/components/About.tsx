...
// Custom hook for counting animation with IntersectionObserver
const useCountUp = (end: number, duration: number, index: number) => {
  ...
  React.useEffect(() => {
    ...
    const initialDelay = 300 + index * 150 + Math.random() * 100; // Base delay + staggered + random offset (0-100ms)
    ...
    const animate = (timestamp: number) => {
      ...
      const progress = Math.min((elapsed - initialDelay) / (duration * 1000), 1);
      // Apply ease-out quadratic function for natural slowdown
    ...
    <div className='pt-0 overflow-x-hidden'>
      ...
      <section className="w-full font-sans">
        <div className="relative w-full h-[300px] md:h-[400px]">
          <img
            src="https://media.audleytravel.com/-/media/images/home/indian-subcontinent/regional-guides/india-to-nepal-where-to-go-in-the-himalaya/istock_540840250_nepal_himalaya_mt_everest_3000x1000.jpg?q=79&w=1920&h=685"
            alt="About Us Header"
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-center bg-black/30 text-white text-center space-y-3">
            ...
            <p className="text-base md:text-lg text-white/90 max-w-2xl">
              For over 15 years, we've been sharing the magic of Nepal's mountains with adventurers from around the world. Our passion for the Himalayas and commitment to authentic experiences sets us apart.
            </p>
          </div>
        </div>
      </section>

      {/* Stats Section with Natural Counting Animation */}
      <section className='py-16 bg-orange-50'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='grid grid-cols-2 md:grid-cols-4 gap-8'>
            {stats.map((stat, index) => {
              const numberValue = parseInt(stat.number.replace('+', '')); // Remove '+' and convert to number
              const { count, ref } = useCountUp(numberValue, 2.5, index); // 2.5 seconds duration, pass index for staggered delay
              return (
                <motion.div
                  key={index}
                  ref={ref}
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-xl text-gray-600 max-w-2xl mx-auto'>
              Our values guide everything we do, ensuring unforgettable and responsible trekking experiences.
            </p>
          </motion.div>
      ...
      <section className='py-20 bg-gradient-to-r from-orange-600 to-orange-700 text-white'>
        <div className='max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <div className='grid md:grid-cols-3 gap-8 text-center mb-5'>
              <div>
