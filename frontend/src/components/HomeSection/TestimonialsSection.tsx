...
//           viewport={{ once: true }}
//         >
//           <h2 className='text-4xl font-bold mb-4'>What Our Trekkers Say</h2>
//           <p className='text-xl text-gray-300 max-w-2xl mx-auto'>
//             Real experiences from adventurers who've explored Nepal's mountains
//             with us
//           </p>
//         </motion.div>
...
const TestimonialSection = () => {
  return (
    <section className='relative py-24 bg-[url("/trekking-bg.jpg")] bg-cover bg-center bg-no-repeat text-white z-10'>
      ...
      <div className='relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='grid md:grid-cols-3 gap-8'>
          {testimonials.map((testimonial, index) => (
            <motion.div
              key={index}
              className='bg-white bg-opacity-90 backdrop-blur-md text-gray-800 rounded-xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300'
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, delay: index * 0.1 }}
              viewport={{ once: true }}
